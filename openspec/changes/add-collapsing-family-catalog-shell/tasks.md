...
- [x] 6.1 Lock the family catalog page to a fixed viewport and move vertical scrolling into the lower catalog row list with the search field pinned at the bottom.
